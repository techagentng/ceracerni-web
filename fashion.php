...
<head>
		<meta charset="utf-8" />
		<title>Fashion Room Design</title>
		<meta name="description" content="Fashion Room Design" />
    ...
    <?php include('inc/menu.php');?>
       ...
       <div class="body-wrapper grid">
		   ...
		   <h1 style="color:white; text-align:center;padding-top:35px;">Fashion Room Design</h1>
		 
		   <div class="img-grid">
			<div class="image">
				<img src="gridImg/FASHION/fashion.jpg" data-delay="0.5s" class="myImg" id="foto">
			</div>

			<div class="image">
				<img src="gridImg/FASHION/self Portrait Canvas.jpg" data-delay="0.5s" class="myImg" id="foto">
			</div>
			</div>
			  <!-- FOOTER -->
