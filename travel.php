...
<head>
		<meta charset="utf-8" />
		<title>Travel Wall Designs Ceracerni</title>
	...
	<?php include('inc/menu.php');?>
       ...
       <div class="body-wrapper grid">
		   ...
		   <div class="image">
			 <img src="gridImg/TRAVEL/Travel-1.jpg" class="myImg" data-delay="0.5s" class="myImg" id="foto">
		   </div>

		   <div class="image">
			 <img src="gridImg/TRAVEL/Travel-2.jpg" class="myImg" data-delay="0.5s" class="myImg" id="foto">
		   </div>

		   <div class="image">
			 <img src="gridImg/TRAVEL/Travel-Oasis.jpg" class="myImg" data-delay="0.5s" class="myImg" id="foto">
		   </div>
