				...
				<div class="display-table">
					<div class="display-table-cell vertical-align-middle">
						<div class="bindA">
							...
							<a href="index.php"><svg xmlns="http://www.w3.org/2000/svg" class="arrow-svg" x="0px" y="0px"
width="50" height="50"
viewBox="0 0 172 172"
				...
				<div class="container">
					...
					<div class="row">
                      ...
                      <div class="col-md-9 col-sm-9">
					     <div class="row">
						 <h2 style="text-align:center;">Baby Room</h2>
							<div class="col-md-12 myGrid">

                              <div class="item1">
								<img src="gridImg/baby-room/baby-room.jpg" data-delay="0.5s" id="foto" class="image">
								
							  </div>
							  
							  <div class="item1">
								<img src="gridImg/baby-room/Babyroom-Sky.jpg" data-delay="0.5s" id="foto">
								
							  </div>
							  
							  <div class="item1">
								<img src="gridImg/baby-room/Babyroom.jpg"  data-delay="0.5s" id="foto" class="image anim">
								
							  </div>
                               
							   <div class="item1">
								 <img src="gridImg/baby-room/Babyroom1.jpg" id="foto" class="image anim">
								 
							  </div>
							  
							  <div class="item1" id="explore-slideto">
								 <img src="gridImg/baby-room/Babyroom2.jpg" id="foto" class="image anim">
								 
							  </div>
							  
							  <div class="item1">
								 <img src="gridImg/baby-room/Babyroom3.jpg" id="foto" class="image anim">
								 
							  </div>
							  
							  <div class="item1">
								 <img src="gridImg/baby-room/Babyroom4.jpg" id="foto" class="image anim">
								 
							  </div>
							  
							  <div class="item1">
								 <img src="gridImg/baby-room/Babyroom8.jpg" id="foto" class="image anim">
								 
							  </div>
							  
							  <div class="item1">
								 <img src="gridImg/baby-room/Babyroom9.jpg" id="foto" class="image anim">
							  </div>
						
							  <div class="item1">
								 <img src="gridImg/baby-room/Bodypaint-Mummy-shoot.jpg" id="foto" class="image anim">
							  </div>
							
							  <div class="item1">
								 <img src="gridImg/baby-room/Body-Paint-mummyshoot.jpg" id="foto" class="image anim">
							  </div>
						</div>
					  </div>
				</div>
