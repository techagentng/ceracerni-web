...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Ceracerni- Layton prep school</title>
				...
				<div class="container">
				  <button class="btn btn-primary"><i class="fa fa-arrow-left"></i><a href="clients.php" style="color: white;">Back to home</a></button>
					<header class="text-center">
						<h1 class="weight-300 size-40">Layton Prep School Works</h1>
						<h2 class="weight-300 letter-spacing-1 size-13"><span>WE TRULY CARE ABOUT OUR CUSTOMERS</span></h2>
					</header>
                
				</div>
				<button class="btn btn-primary" style="float:right;padding-right: 20px;margin-top:-90px;margin-right:40px;">Back to home  <i class="fa fa-arrow-right"></i></button>
			</section>
			<!-- /CALLOUT -->	
					<!-- WORK -->
