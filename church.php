...
<head>
	...
	<?php include('inc/menu.php');?>
       ...
       <div class="body-wrapper grid">
		   ...
		   <div class="heading">
			   <h1>Church Wall Designs</h1>
		   </div>
		   <div class="main">
		   
		   <div class="img-grid">
		   <div class="image">
			 <img src="gridImg/CHURCH/BTS4.jpg" data-delay="0.5s" id="foto">
		   </div>

		   <div class="image">
			 <img src="gridImg/CHURCH/BTS5.jpg" data-delay="0.5s" id="foto">
		   </div>

		   <div class="image">
			 <img src="gridImg/CHURCH/church.jpg" data-delay="0.5s" id="foto">
		   </div>

		   <div class="image">
			 <img src="gridImg/CHURCH/church2.jpg" data-delay="0.5s" id="foto">
		   </div>
